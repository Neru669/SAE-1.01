...
public class OptiTrou {
    ...
    public static void afficheGrille(int k, int[][] g) {
        ...
        for (int i = 0; i < g.length; i++) {
            ...
            for (int j = 0; j < g.length; j++) {
                ...
                if (g[i][j] == -1) { //POUR VOIR TROUEV DANS PILE
                    System.out.print("x");
                }
                else if (g[i][j] == 0) {
                    System.out.print(".");
    ...
    public static void synchroTrouEvident(int[][] gOrdi, int [][] nbValPoss, int i, int j, int [][] tabTrouEvident, boolean checkTrouEvident){
     ...
     */
    public static int tourOrdinateur(int[][] gOrdi, boolean[][][] valPossibles, int[][] nbValPoss, int [][] tabTrouEvident) {
        // ________________________________________________________________________________________________
