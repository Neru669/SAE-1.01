...
//============================================================================================
     ...
     * action : effectue un tour de l'ordinateur
     */
    public static int tourOrdinateurV2(int[][] gOrdi, boolean[][][] valPossibles, int[][] nbValPoss) {
        // ________________________________________________________________________________________________
        // return -1 => triche
        int [] tab = chercheTrouV1(gOrdi, nbValPoss); //coord du premier trou à remplir par Ordi
            ...
            else if (nbValPoss[tab[0]][tab[1]] == 1){ //check trou evident
                gOrdi[tab[0]][tab[1]] = uneValeur(valPossibles[tab[0]][tab[1]]);
                reponse = askHumanToConfirm(tab[0], tab[1], gOrdi[tab[0]][tab[1]]); //demande de confirmation meme si evident (EXTENSION1)
    ...
    public static int partie() {
        ...
        for (int i = 0; i<nbTrou;i++){
            ...
            int check = tourOrdinateurV2(gOrdi, valPossibles, nbValPoss); //EXTENSION2
            if (check == -1) {
