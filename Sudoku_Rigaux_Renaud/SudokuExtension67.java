...
public class SudokuExtension67 {
     ...
     * EXTENSION5
     * FONCTION AJOUTEE
     * prerequis : grille et gSecret sont des grilles de Sudoku
     * action : rassemble les fonctions de transformations, et 
     * réalise une succession de 100 transformations choisis aléatoirment
     * dans une seule et même fonction. 
     */
    ...
    /**
     * pre-requis : gSecret est une grille de sudoku complete
     * gIncomplete est une grille de sudoku incomplete
     * valPossibles est une grille 9x9x9 de booleans
     * nbValPoss est une grille 9x9
     * action : transforme une gIncomplete en une grille de niveau facile 
     * avec des trous évidents à chaque tour.
     */
    public static int initGrilleIncompleteV5(int[][] gSecret, int[][] gIncomplete, 
    boolean[][][] valPossibles, int[][] nbValPoss) {
        ...
        while (!aParcouruToutGrille) {
            ...
            while (!aTrouverCasePourTrouEvident && !aParcouruToutGrille) {
                ...
                if (gIncomplete[i][j] != 0) { // Verifier si rempli
                    ...
                    gIncomplete[i][j] = 0; //faire comme si c'etait un trou
        ...
        flipFlopGrille(gIncomplete, gSecret); //transformer les grilles apres chaque trou evident crée 
        }
...
//============================================================================================
    ...
    public static int initPartie(int[][] gSecret, int[][] gHumain, int[][] gOrdi, boolean[][][] valPossibles,
        ...
        int nb = initGrilleIncompleteV5(gSecret, gHumain, valPossibles, nbValPoss); //EXTENSION5
     ...
     * FONCTION AJOUTEE
     * pre-requis : input est un entier entre 1 et 9
     * int i,j entre 0 et 8 correspond à la ligne de la case à verifier
     * grille est une grille de sudoku Incomplete
     * action : vérifie si la valeur input est la seule valeur unique presente dans la ligne i
     * return : true si oui, false sinon
     */
     ...
     * int i,j entre 0 et 8 correspond à la ligne de la case à verifier
     * grille est une grille de sudoku Incomplete
     * action : vérifie si la valeur input est la seule valeur unique presente dans la colonne j
     * return : true si oui, false sinon
     */
     ...
     * int i,j entre 0 et 8 correspond à la ligne de la case à verifier
     * grille est une grille de sudoku Incomplete
     * action : vérifie si la valeur input est la seule valeur unique presente dans le carre (i, j)
     * return : true si oui, false sinon
     */
     ...
     * EXTENSION6
     * FONCTION AJOUTEE
     * action : fonction d'initialisation des grilles 9x10x9 colPossibles et 
     * ligPossibles et des grilles 9x10 nbColPoss et nbLigPoss
     * 
     */
    public static void initPossiblesColLig (int[][] gOrdi, boolean[][][] valPossibles,
        ...
        //verifier si les colonnes contenant les trous contiennent cette valeur
        // Pour une ligne i
        for (int i = 0; i < gOrdi.length; i++) {
     ...
     * EXTENSION7
     * FONCTION AJOUTEE
     * prérequis : gOrdi une grille de Sudoku
     * nbValPoss une grille 9x9 contenant les cardinals des valeurs possibles pour 
     * chacune des cases de GOrdi
     * k un entier qui correspond au cas du nbValPossible traité comme vue dans la stratégie
     * i correspond à l'indice de la ligne concernée
     * action : stocke dans un tableau les indices des colonnes pour lequel nbValPoss = k
     */
     ...
     * nbValPoss une grille 9x9 contenant les cardinals des valeurs possibles pour 
     * chacune des cases de GOrdi
     * ligne correspond à l'indice de la ligne concernée
     * valPoss est une grille 9x9x10 contenant l'ensembles des valeurs possibles des trous.
     * action : si pour deux cases ou nbValPoss=2, les ValPossibles sont identiques, alors 
     * on les supprime sur toute la ligne,colonne,carre de ces deux cases sauf pour eux-meme.
     * on fait ca pour toutes les couples possibles de la ligne.
     */
                ...
                if (ValPossEgal(valPoss, ligne, j, ligne, j2)) {
                    for (int k = 1; k < valPoss[ligne][j].length; k++) {
                        if (valPoss[ligne][j][k]) {
                            ...
                            //faudrait ajouter une fonction pour Colonne et carre des cases concernées
                        }
                    }
                }
            }
     ...
     * EXTENSION7
     * FONCTION AJOUTEE
     * action : suprrime les valeurs dans nbValPossibles du couple sur toute la ligne sauf eux-memes.
     */
     ...
     * EXTENSION7
     * FONCTION AJOUTEE
     * action : verifie pour un couple ou nbValPos = 2 pour les deux cases, si leurs valeurs possibles
     * sont identiques.
     * retrun : true si vrai, false sinon.
     */
